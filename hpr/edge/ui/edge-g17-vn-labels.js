...
function labelLayers(map){return(map.getStyle?.()?.layers||[]).filter(l=>l?.id!==LAYER_ID&&l?.type==='symbol'&&/place|city|town|settlement|label/i.test(l.id||'')&&l.layout?.['text-field'])}
