...
document.addEventListener('DOMContentLoaded',()=>{style();decorate();const d=$('#detailBody');if(d)new MutationObserver(()=>queueMicrotask(decorate)).observe(d,{childList:true,subtree:true});setInterval(decorate,1500)},{once:true});
