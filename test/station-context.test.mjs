...
for(const path of ['/api/readsb/receiver.json','/data/stats.json','/api/readsb/station.json'])assert.match(ui,new RegExp(path.replaceAll('/','\\/')));
console.log('G5 PASS: receiver, stats, and station context use named fields');
