...
ARG FE_VERSION=4.8.1-edge.1
ARG FE_BUILD=260914.6
...
RUN sed -i \
    ...
    && printf '{"fe":"%s","build":"%s","airwire":"binary-v1","meta":"0x0a-type-reg","trace":"readsb-real","marker":"cf-acicon","flags":"icao24-local","photo":"planespotters-lazy","traffic_api":"traffic.hpradar.com-selected-only","table":"stable-2.5s","ux":"e1-e7-fr24-airnav","map_labels":"vi-hoangsa-truongsa"}\n' "$FE_VERSION" "$FE_BUILD" > /usr/share/nginx/html/version.json \
