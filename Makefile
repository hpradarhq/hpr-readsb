...
HPR_AIRWIRE_OBJ = hpr/airwire/hpr_airwire.o hpr/airwire/hpr_airwire_bin.o hpr/airwire/hpr_airwire_ws.o
...
readsb: readsb.o argp.o anet.o interactive.o mode_ac.o mode_s.o comm_b.o json_out.o $(HPR_AIRWIRE_OBJ) net_io.o crc.o demod_2400.o \
...
clean:
	rm -f *.o hpr/airwire/*.o uat2esnt/*.o oneoff/*.o compat/clock_gettime/*.o compat/clock_nanosleep/*.o compat/apple/*.o readsb viewadsb cprtests crctests test/hpr_airwire_bin_test oneoff/convert_benchmark

test: cprtest crctest hpr-airwire-test
...
hpr-airwire-test: test/hpr_airwire_bin_test
	./test/hpr_airwire_bin_test

test/hpr_airwire_bin_test: hpr/airwire/hpr_airwire_bin.c hpr/airwire/hpr_airwire_bin.h test/hpr_airwire_bin_test.c
	$(CC) $(CFLAGS) -I. -o $@ hpr/airwire/hpr_airwire_bin.c test/hpr_airwire_bin_test.c -lm
